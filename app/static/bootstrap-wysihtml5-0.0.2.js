    ...
    var templates = function(key, locale) {
        ...
        var tpl = {
            ...
            "lists":
                "<li>" +
                  "<div class='btn-group'>" +
                    "<a class='btn' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "'><span class='glyphicon glyphicon-list' aria-hidden='true'></span></a>" +
                    "<a class='btn' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "'><span class='glyphicon glyphicon-th-list' aria-hidden='true'></span></a>" +
